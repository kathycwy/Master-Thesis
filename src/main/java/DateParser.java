...
public class DateParser {
    ...
    Date date = finalFormatter.parse("2013-01-01");
...
//            case 6:
//                return dateParser6(str);
//            case 7:
//                return dateParser7(str);
        }
...
//        return finalFormatter.format(date);
    ...
    public static String dateParser6(String str) throws ParseException {

        return "N/A";
    }

    public static String dateParser7(String str) throws ParseException {
